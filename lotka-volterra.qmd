...
::: {.callout-note}
## **Credit:** 
This code is closely based on the article [Numerically solving differential equations with R](https://rstudio-pubs-static.s3.amazonaws.com/32888_197d1a1896534397b67fb04e0d4899ae.html). One tiny change! One tiny change!
:::
...
parameters <- c(r = .95, alpha = 0.6, beta = 0.5, q = 1)
